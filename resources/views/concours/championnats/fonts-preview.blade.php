...
<body>
    <h1>Apercu des polices cursives</h1>
    <p class="subtitle">Exemple de rendu du titre de la start list (couleur orange #F97316). La police actuellement utilisee dans le PDF est marquee.</p>
    ...
    <p style="margin-top: 30px; font-size: 13px; color: #666;">
        Pour changer la police utilisee dans le PDF, indique-moi laquelle tu preferes.
    </p>
</body>
</html>
