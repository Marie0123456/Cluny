...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('concours/{concours}')->name('concours.')->middleware(['concours.access', 'role:admin'])->group(function () {
        ...
        Route::post('/import/pdf-prix', [ImportController::class, 'importPdfPrix'])->name('import.pdf-prix');
    ...
    Route::prefix('concours/{concours}')->name('concours.')->middleware(['concours.access', 'role:admin,compta'])->group(function () {
        ...
        Route::patch('/factures/{client}/toggle-item-fait', [FactureController::class, 'toggleClientFait'])->name('factures.toggle-item-fait')->middleware('role:compta');
